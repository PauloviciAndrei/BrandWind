...
import CalendarEventsBodyRightDrawer from '../features/calendar/components/CalendarEventsBodyRightDrawer';
...
function RightSidebar() {
  ...
  return (
    <div
      className={
        'fixed overflow-hidden z-20 bg-base-300/40 backdrop-blur-sm inset-0 transform ease-in-out ' +
        (isOpen
